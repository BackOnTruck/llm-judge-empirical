...
API_KEY = {
    deepseek_25: 'xxxxxxxx',
    gpt4o: 'xxxxxxxx',
    davinci: 'xxxxxxxx',
    openai_embed: 'xxxxxxxx',
}
...
- 5/5: Exceptionally easy to read and idiomatic, with clear structure and language-native patterns.
- 4/5: Mostly readable and idiomatic, with only minor issues or deviations from target language norms.
- 3/5: Readable but has noticeable structural or idiomatic weaknesses that could hinder comprehension.
- 2/5: Difficult to follow due to poor readability or unidiomatic constructs, though partially understandable.
- 1/5: Very hard to understand with severe readability issues, using non-idiomatic or unnatural patterns.
...
- 5/5: Highly similar in meaning and functionality, with no differences or omissions.
- 4/5: Mostly consistent, with only minor differences that do not affect overall functionality.
- 3/5: Somewhat consistent, but has noticeable differences that may affect interpretation or behavior.
- 2/5: Significant differences or omissions that change meaning or functionality, though the general intent remains.
- 1/5: Poorly aligned with the source, with major differences that alter core functionality or meaning.
"""
