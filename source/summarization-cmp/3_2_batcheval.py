...
Each sample contains a code snippet, and two summaries of its core functionality.
You are to compare the quality of both summaries, without considering the quality of the code, and decide which one is noticeably better or declare a tie because their difference in quality is insignificant.
