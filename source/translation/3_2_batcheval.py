...
Each sample contains an original code snippet, and a snippet translated into another programming language.
...
def solve(batch: List[Dict[str, Union[str, float]]], bar: tqdm):
    ...
    for i, sample in enumerate(batch, start=1):
        ...
        contexts += template_per_sample.format(i, src_lang, sample['input'], tgt_lang, sample['output'])
