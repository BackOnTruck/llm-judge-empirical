            ...
            for j in range(3):
                for k in range(3):
                    if j != k:
                        ...
                        src_lang, tgt_lang = samples[0]['lang'].split(', ')
                        prompts += [template.format(src_lang, tgt_lang, src_lang, samples[0]['input'], tgt_lang, samples[j]['output'], tgt_lang, samples[k]['output'])]
                        instances += [{}]
