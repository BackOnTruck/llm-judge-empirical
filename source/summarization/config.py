...
minlen_context, maxlen_context, maxlen_resp, maxlen_output = 15, 1536, 1536, 1024
...
RESPONDED_DATA = ['test-D-responded.jsonl']
...
#! varies per task
CRITERIA = """
1. Readability: How clear, concise, and fluent is the summary in describing the code’s function?

- 5/5: Extremely clear, concise, and well-structured, making it very easy to understand.
...
2. Consistency: How well does the summary capture the key functionality of the code without leaving out important details or adding less critical ones?

- 5/5: Perfectly aligns with the code, accurately capturing all key functionality without leaving out important details or adding less critical ones.
- 4/5: Largely consistent with the code, capturing key functionality, but adding a few less important details.
- 3/5: Somewhat consistent, capturing the general functionality but omitting some important aspects or introducing several less critical details.
- 2/5: Inconsistent, with significant omissions or additions that make the summary misaligned with the key functionality of the code.
- 1/5: Highly inconsistent, missing crucial functionality or adding irrelevant content, leading to a summary that poorly represents the code.
"""
